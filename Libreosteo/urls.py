...
from libreosteoweb.api.views import PatientViewSet, RegularDoctorViewSet, ExaminationViewSet, SearchViewHtml, UserViewSet, StatisticsView, OfficeEventViewSet
...
router.register(r'events', OfficeEventViewSet)
