...
urlpatterns = [
    ...
    url(r'^api/patients/(?P<patient>.+)/documents$',
    ...
    url(r'^web-view/partials/set-password-modal',
        displays.display_setpassword),
    url(r'^web-view/partials/office-settings$',
