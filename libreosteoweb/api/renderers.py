...
class InvoiceCSVRenderer(renderers.CSVRenderer):
    labels = {
        ...
        'professional_id': 'Identifiant professionel',
        'professional_id_label': 'Libellé d\'identifiant',
        'location': 'lieu',
        'number': 'Numéro',
        ...
        'footer': 'pied de page',
        'office_identifier': 'Identifiant de la structure',
        'office_identifier_label': 'Libellé d\'identifiant',
