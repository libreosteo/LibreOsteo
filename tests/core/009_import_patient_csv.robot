...
Import File Success
  ...
  Wait Until Element Contains           jquery:div.panel-success>div.panel-heading    Importation réussie                         timeout= 20s
  Wait Until Element Contains           jquery:div.panel-success>div.panel-body       100 lignes importées du fichier patient

Import File With Error In Patient
  Click Button                          jquery:button.btn-success:contains("Importer")
  Wait That Import Is Complete
  Wait Until Element Contains           jquery:div.panel-warning>div.panel-heading    Importation réussie avec des erreurs         timeout= 20s
